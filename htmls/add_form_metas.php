    ...
    <div class="form-field form-type-wrap">
        ...
        <select id="type" name="type">
        	<option value="continent"<?php if ($this->type == 'notarea') echo ' selected="selected"'; ?>>
    ...
    <div class="form-field form-enable_start-wrap">
        ...
        <input type="text" id="enable_start" name="enable_start" value="<?php  echo $this->enableStart; ?>" />
	</div>
    <div class="form-field form-enable_end-wrap">
        <label><?php echo __('enable_end',AREAMANAGER); ?></label>
        <input type="text" id="enable_end" name="enable_end" value="<?php  echo $this->enableEnd; ?>" />
	</div>
    <div class="form-field form-central-wrap">
        <label><?php echo __('central',AREAMANAGER); ?></label>
        <input type="text" id="central" name="central" value="<?php  echo $this->central; ?>" onchange="centralChange()" />
	</div>
